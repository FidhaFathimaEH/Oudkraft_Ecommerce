  ...
  return (
    <motion.article
      whileHover={{
        ...
        scale: 1.01,
        boxShadow:
          '0 28px 70px -24px rgba(13,59,46,0.35)',
      }}
      transition={{ duration: 0.3 }}
      className="group overflow-hidden rounded-[32px] border border-[#e7d7b9] bg-white shadow-[0_20px_60px_-30px_rgba(13,59,46,0.25)]"
    >
      {/* Product Image */}
